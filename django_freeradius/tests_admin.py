...
class UserTest(TestCase):
    ...
    def test_users_nas(self):
        ...
        obj = Nas.objects.create(nas_name='fiore', short_name='ff', type='cisco', secret='d', ports='22', community='vmv', description='ciao', server='jsjs')
    ...
    def test_users_check(self):
        User.objects.create_superuser(username='fiorella', password='ciao', email='giggi_fiore@gmail.it')
        obj = RadiusCheck.objects.create(user_name='bob', attribute='Cleartext-Password', op=':=', value='passbob')
        self.client.login(username='fiorella', password='ciao')
    ...
    def test_users_reply(self):
        User.objects.create_superuser(username='fiorella', password='ciao', email='giggi_fiore@gmail.it' )
        obj = RadiusReply.objects.create(user_name='bob', attribute='Cleartext-Password', op=':=', value='passbob')
        self.client.login(username='fiorella', password='ciao')
    ...
    def test_users_group_reply(self):
        User.objects.create_superuser(username='fiorella', password='ciao', email='giggi_fiore@gmail.it' )
        obj = RadiusGroupReply.objects.create(group_name='students', attribute='Cleartext-Password', op=':=', value='PPP')
        self.client.login(username='fiorella', password='ciao')
    ...
    def test_users_group_check(self):
        User.objects.create_superuser(username='fiorella', password='ciao', email='giggi_fiore@gmail.it' )
        obj = RadiusGroupCheck.objects.create(group_name='students', attribute='Cleartext-Password', op=':=', value='PPP')
        self.client.login(username='fiorella', password='ciao')
    ...
    def test_users_group(self):
        User.objects.create_superuser(username='fiorella', password='ciao', email='giggi_fiore@gmail.it')
        obj = RadiusGroup.objects.create(id='870df8e8-3107-4487-8316-81e089b8c2cf', group_name='students', priority='1', creation_date='2017-09-02', modification_date='2017-08-03', notes='hh')
        self.client.login(username='fiorella', password='ciao')
    ...
    def test_users_groupusers(self):
        ...
        #for radiusgroupusers in reply.radiusgroupusers_set.all():
            #radiusgroupusers.radius_reply.add(reply)
        #for radiusgroupusers in check.radiusgroupusers_set.all():
            #radiusgroupusers.radius_check.add(check)

    def test_users_accounting(self):
        User.objects.create_superuser(username='fiorella', password='ciao', email='giggi_fiore@gmail.it' )
        ola = RadiusAccounting.objects.create(
        acct_unique_id='-2', user_name='bob', nas_ip_address='ff', acct_start_time='2017-06-10 10:50:00', acct_stop_time='2017-06-10 12:10:00', acct_session_time='5', acct_authentic='kj', connection_info_start='f', connection_info_stop='hgh', acct_input_octets='1' ,acct_output_octets='4', rad_acct_id='123')
        self.client.login(username='fiorella', password='ciao')
