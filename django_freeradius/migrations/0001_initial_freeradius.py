    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('framed_ipv6_prefix', models.CharField(blank=True, db_column='framedipv6prefix', max_length=44, null=True, validators=[ipv6_network_validator], verbose_name='framed IPv6 prefix')),
                ...
                ('delegated_ipv6_prefix', models.CharField(blank=True, db_column='delegatedipv6prefix', max_length=44, null=True, validators=[ipv6_network_validator], verbose_name='delegated IPv6 prefix')),
